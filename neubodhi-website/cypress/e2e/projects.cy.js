describe('NeuBodhi Projects Page Navigation', () => {
  ...
  // ============================================
  it('should redirect to ISACA project page when clicking project video', () => {
  ...
  // ============================================
  it('should redirect to ISACA project page when clicking Learn More', () => {
  ...
  it('should validate ISACA project page content', () => {
  ...
  // ============================================
  it('should redirect to Contact Us page when clicking Connect Now button on ISACA Project Page', () => {
